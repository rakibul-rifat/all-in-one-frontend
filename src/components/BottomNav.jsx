        ...
        >
          {active === tab.href && (
            <motion.div
              ...
              className="absolute -top-4 w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center shadow-lg border-2 border-gray-800"
          ...
          <motion.div
            ...
            className={`relative z-10 transition-colors ${
              active === tab.href ? "text-cyan-600" : "text-gray-400"
            }`}
          >
            {tab.icon}
          </motion.div>
